...
2. реквест
     ...
     по поводу подключения проверки входящих данных с помощью реквеста ... считаю эту штуку не нужной и избыточной .. так как орабатывается чёткая структура массива и значения параметров могут быть любыми (от иньекций код защищён так как использую ОРМ а не сырый запросы) 
3. какой формат базы данных вы считаете верной ? ... хотя и текущая полностью выполняет свою функцию 
